...
#show: project.with(
  id: "1X01",
  title-ja: "第70回宇宙科学技術連合講演会原稿見本",
  title-en: "Sample Format of Paper for the 70th Space Sciences and Technology Conference",
  authors: (
    (
      name-ja: "航空一郎",
      name-en: "Ichiro Koku",
  ...
  abstract: [
    This paper instructs how to prepare your manuscript for the 70th Space Sciences and Technology Conference. All the final manuscripts should be written by word processors with the format specified in this manual. You are kindly requested to submit your manuscript in an electronic file on the 70th Space Sciences and Technology Conference website by #text(fill: red)[*21, August 2026*].
  ],
  keywords: (
    "Space Science",
    "Space Technology",
...
これは，第70回宇宙科学技術連合講演会講演集の原稿見本兼作成要領です．作成要領は，基本的に日本航空宇宙学会標準の講演会原稿作成要領 @2001-jsass によりますが，論文原稿の書式に統一性を持たせるために，今回ここに見本として，本作成要領を示します．両者に矛盾がある場合は，本稿が優先します．できる限り本稿と同じ，もしくは近い書式で作成していただきますようお願いいたします．
...
#figure(
  table(
    ...
    [余白], [左右各約23mm，上下各約25mm#linebreak()最低この程度は残して下さい],
    [字体], [明朝体#linebreak()（英数字はTimes-New-Roman）],
...
講演集はシステムからダウンロードしていただきます．図・表にはカラーも使用可能です．キャプションは，図には下，表には上に配置して下さい．また，図や表と本文の間には適度な余白を入れて下さい．なお，PDFファイル中への動画の埋め込みは，動作環境によっては正常に再生できない可能性があるため，禁止とさせていただきます.
...
講演集原稿は，#text(fill: red)[#underline[*8月21日*]]までに講演会HPの電子投稿システムを用いて，#underline[*PDF形式*]の電子ファイルで提出願います．原稿アップロード依頼のメールに記載されている URL より電子投稿システムのWEBサイトにアクセスし，原稿をアップロードして下さい．作成の便宜のため，本ファイルは*Word形式*ですが，#underline[*受け入れ可能なのはPDF形式のみ*]ですのでご注意願います．PDFファイルは#underline[*5MB以下*]になるように作成していただくよう願います．なお，原稿の提出時には講演番号と申込時に入力したメールアドレスが必要です．講演番号はプログラム編成後に原稿アップロード依頼のメールでお知らせします．
...
書式につきましては，最低限守っていただきたいことを除けば，著者の判断に任せます．ただし，読み易いことを最優先していただきますようお願いいたします．その他，不明なことがありましたら，宇宙科学技術連合講演会・実行委員会・講演集担当#text(fill: red)[ukaren70\@pcojapan.jp]までご連絡下さい．
